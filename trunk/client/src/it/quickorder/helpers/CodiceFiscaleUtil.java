...
public class CodiceFiscaleUtil
{
	...
	public static boolean isValid(String codiceFiscale, String nome, String cognome, Date dataNascita, char sesso, String luogoNascita)
	{
	...
	private static String cercaComune(String comune)
	{
		return "";
		//la lettura deve essere effettua all'interno dell'activity
		// suggerisco il passaggio dello stream dall'activity a questa classe tramite controllodati
		// saluti
		/*
		FileInputStream f = openFileInput("ITALIA.csv");
		try
		{
