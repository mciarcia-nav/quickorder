...
public class ControlloCodiceFiscale 
{
	...
	public static String isValid(String codiceFiscale, String nome, String cognome, Date dataNascita, char sesso)
	{
		String messaggio="";
		...
		if (!codiceFiscale.substring(0, 3).equalsIgnoreCase(check))
		{
			...
			messaggio = "(Errore consonanti cognome nel codice fiscale)";
			return messaggio;
		}
		...
		if (!codiceFiscale.substring(3, 6).equalsIgnoreCase(check))
		{
			...
			messaggio = "(Errore consonanti nome nel codice fiscale)";
			return messaggio;
		}
		...
		if (!check.equalsIgnoreCase(codiceFiscale.substring(6, 11)))
		{
			...
			messaggio = "(Errore data di nascita nel codice fiscale)";
			return messaggio;
		}
		return messaggio="ok";
	}
